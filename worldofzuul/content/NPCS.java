...
public class NPCS extends NPC {
    ...
    public void createNPCS() {
        ...
        mentor.setWelcome("< You must be a new student, welcome! \n"
                + "\n < Mentor: As you can see below, you have two options, type \n \"choose 1\" to choose the first, \n and I'll let you figure out the rest.\n");
        mentor.setDialogOptions("< 1: talk"
                + "\n< 2: leave");
        mentor.setAcceptString("< Good luck student! \n"
                + "\n< Mentor: Now that you accepted a quest,"
                + "\n< you can type journal, and the quest's name \n"
                + "< and a short description will pop up. Complete this quest to advance."
                + "\n< To go to a room, you must type \'go\' and then the direction"
                + "\n< you want to go, there are four directions:\n"
        ...
        mentor.setQuestString("< Hello there!"
                ...
                + "\n< To find the first room you have to head north.\n"
        ...
        mentor.setCompleteQuestString("Yes! you found the ID-card!"
                ...
                + "< Mentor: Congratulations! You finished your very first quest."
        ...
        andars.setQuestString("< Welcome to SDU. I am Andars, a very skilled programmer,"
                + "\n< and I rock a mean cap"
                + "\n< You know, a thing between you and me. The book,"
                + "\n< called Best Java Book for learning Java EVER!. It is the best book to prepare you"
        ...
        bookstoreLady.setAcceptString("< I knew a strong man like you, wouldn't be afraid"
                + "\n< of a grown woman like myself.");
        ...
        bookstoreLady.setCompleteQuestString("< Thx for the coffee. The book is back in the storage room,"
                + "\n< you can go get it.");
        ...
        student.setCompleteQuestString("< Thank you so much, now there is a slight chance"
                + "\n< I'll pass the exam.");
